...
parser.add_argument('--gpu_id', dest='gpu_id', type=str, default='1', help='if use gpu, use gpu device id') #修改为默认为1
...
# we trained our model from scratch. 从头开始训练模型
...
cfg.num_filter_parameters = 15 #一共15个参数
