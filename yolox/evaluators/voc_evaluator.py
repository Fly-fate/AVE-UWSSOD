    ...
    def evaluate(
        ...
        for cur_iter, (imgs, _, info_imgs, ids) in enumerate(progress_bar(self.dataloader)):
            with torch.no_grad():
                ...
                #inps_256_256 = nn.functional.interpolate(imgs, size=(256,256)) #1 #将输入图像缩放为256*256

                inps_304_304 = nn.functional.interpolate(imgs, size=(256,256))
                outputs = model(inps_304_304, imgs) #2
                #outputs = model(imgs)
